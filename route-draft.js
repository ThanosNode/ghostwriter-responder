...
// Deploy path: /api/route-draft  (place file at /api/route-draft.js in your Vercel project)
...
function buildSystemPrompt(brandTone) {
  ...
  const toneInstruction = toneInstructions[toneKey];
...
export default async function handler(req, res) {
  ...
  // ── 3. Gatekeeper: Subscription Status Check ─────────────────────────────
